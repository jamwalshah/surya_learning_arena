# M03.01 Describe cost management in Azure
...
![Screenshot of storage blob settings showing hot and cool access tiers. (https://learn.microsoft.com/en-us/training/wwl-azure/describe-cost-management-azure/media/blob-storage-768af5f7.png)](../../../content/blob-storage-768af5f7.png)
...
![Screenshot of Azure virtual machine settings showing the virtual machine size options. (https://learn.microsoft.com/en-us/training/wwl-azure/describe-cost-management-azure/media/virtual-machine-settings-519925fc.png)](../../../content/virtual-machine-settings-519925fc.png)
...
![Screenshot of the pricing calculator for reference. (https://learn.microsoft.com/en-us/training/wwl-azure/describe-cost-management-azure/media/price-calculator-0a750ac3.png)](../../../content/price-calculator-0a750ac3.png)
...
![Screenshot of the Total Cost of Ownership calculator. (https://learn.microsoft.com/en-us/training/wwl-azure/describe-cost-management-azure/media/total-cost-ownership-657fe344.png)](../../../content/total-cost-ownership-657fe344.png)
...
![A diagram showing a potential Azure solution for hosting an application. (https://learn.microsoft.com/en-us/training/wwl-azure/describe-cost-management-azure/media/estimate-costs-architecture-171ae4c1.png)](../../../content/estimate-costs-architecture-171ae4c1.png)
...
2. Notice the following tabs:
    ...
    ![A screenshot of the Pricing calculator menu bar with the Products tab selected. (https://learn.microsoft.com/en-us/training/wwl-azure/describe-cost-management-azure/media/price-calculator-menu-bar-4a43e988.png)](../../../content/price-calculator-menu-bar-4a43e988.png)
...
![Illustration of the three steps: define your workloads, adjust assumptions, and view the report. (https://learn.microsoft.com/en-us/training/wwl-azure/describe-cost-management-azure/media/total-cost-ownership-calculator-steps-76e927a5.png)](../../../content/total-cost-ownership-calculator-steps-76e927a5.png)
...
![Screenshot of initial view of cost analysis in the Azure portal. (https://learn.microsoft.com/en-us/training/wwl-azure/describe-cost-management-azure/media/cost-analysis-b52dedab.png)](../../../content/cost-analysis-b52dedab.png)
