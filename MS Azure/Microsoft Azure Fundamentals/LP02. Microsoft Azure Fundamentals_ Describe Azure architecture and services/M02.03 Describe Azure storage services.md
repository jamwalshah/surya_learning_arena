# M02.03 Describe Azure storage services
...
![Diagram showing the structure used for locally redundant storage. (https://learn.microsoft.com/en-us/training/wwl-azure/describe-azure-storage-services/media/locally-redundant-storage-37247957.png)](../../../content/locally-redundant-storage-37247957.png)
...
![Diagram showing ZRS, with a copy of data stored in each of three availability zones. (https://learn.microsoft.com/en-us/training/wwl-azure/describe-azure-storage-services/media/zone-redundant-storage-6dd46d22.png)](../../../content/zone-redundant-storage-6dd46d22.png)
...
![Diagram showing GRS, with primary region LRS replicating data to LRS in a second region. (https://learn.microsoft.com/en-us/training/wwl-azure/describe-azure-storage-services/media/geo-redundant-storage-3432d558.png)](../../../content/geo-redundant-storage-3432d558.png)

### Geo-zone-redundant storage

GZRS combines the high availability provided by redundancy across availability zones with protection from regional outages provided by geo-replication. Data in a GZRS storage account is copied across three Azure availability zones in the primary region (similar to ZRS) and is also replicated to a secondary geographic region, using LRS, for protection from regional disasters. Microsoft recommends using GZRS for applications requiring maximum consistency, durability, and availability, excellent performance, and resilience for disaster recovery.

![Diagram showing GZRS, with primary region ZRS replicating data to LRS in a second region. (https://learn.microsoft.com/en-us/training/wwl-azure/describe-azure-storage-services/media/geo-zone-redundant-storage-138ab5af.png)](../../../content/geo-zone-redundant-storage-138ab5af.png)
...
6. On the **Advanced** tab of the Create a storage account blade, fill in the following information. Leave the defaults for everything else.
    ...
    ![Screenshot showing how to enable anonymous-access containers on a storage account. (https://learn.microsoft.com/en-us/training/wwl-azure/describe-azure-storage-services/media/storage-account-anonymous-containers-5e5f584a.png)](../../../content/storage-account-anonymous-containers-5e5f584a.png)
...
1. Under **Data storage**, select **Containers**.
    ![Screenshot of the Container add section of a storage account. (https://learn.microsoft.com/en-us/training/wwl-azure/describe-azure-storage-services/media/storage-account-menu-9472480e.png)](../../../content/storage-account-menu-9472480e.png)
...
3. Set the Anonymous access level to Blob (anonymous read access for blobs only).
    ...
    ![Screenshot with Change access level highlighted. (https://learn.microsoft.com/en-us/training/wwl-azure/describe-azure-storage-services/media/blob-access-level-213a74e6.png)](../../../content/blob-access-level-213a74e6.png)
