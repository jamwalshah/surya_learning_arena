# M02.02 Describe Azure compute and networking services
...
3. As an optional step, try to access the web server from a browser:
    ...
    ![Screenshot of a web browser showing an error message that says the connection timed out.(https://learn.microsoft.com/en-us/training/wwl-azure/describe-azure-compute-networking-services/media/browser-request-timeout-d7cc0e02.png)](../content/browser-request-timeout-d7cc0e02.png)
...
![SA screenshot of a web browser showing the home page from the web server. The home page displays a welcome message. (https://learn.microsoft.com/en-us/training/wwl-azure/describe-azure-compute-networking-services/media/browser-request-successful-df21c6f1.png)](../content/browser-request-successful-df21c6f1.png)
